# fantasy-gurobi.py
# https://github.com/srome/srome.github.io/blob/master/files/nfl_optimizer/nfl_optimizer.py
# https://srome.github.io/How-to-Use-Math-to-Win-at-Fantasy-Football-With-a-Lineup-Optimizer/
...
def main():
    player_data = pd.read_csv('data.csv', index_col=0 )
