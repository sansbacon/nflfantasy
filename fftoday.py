...
class Parser():
    ...
    def _teams(self, name):
        ...
        names = {'Arizona': 'ARI', 'Atlanta': 'ATL', 'Baltimore': 'BAL', 'Buffalo': 'BUF', 'Carolina': 'CAR',
                 ...
                 'Seattle Seahawks': 'SEA', 'Philadelphia Eagles': 'PHI', 'St. Louis Rams': 'LARM',
    ...
    def weekly_results(self, content, season, week, position):
        ...
        '''
        if position == 'DST':
            headers = ['g', 'sack', 'fumbles_recovered', 'interceptions', 'def_td', 'points_allowed',
                       'pass_yds_allowed', 'rush_yds_allowed', 'safety', 'kick_td', 'fantasy_points',
                       'fantasy_points_g']
            return self._parse(content, headers, season, week, 'DST')

        elif position == 'QB':
            headers = ['team', 'g', 'pass_cmp', 'pass_att', 'pass_yds', 'pass_td', 'pass_int', 'rush_att', 'rush_yds',
                       'rush_td', 'fantasy_points', 'fantasy_points_g']
            return self._parse(content, headers, season, week, 'QB')

        elif position == 'RB':
            headers = ['team', 'g', 'rush_att', 'rush_yds', 'rush_td', 'rec_target', 'rec_rec', 'rec_yds', 'rec_td',
                       'fantasy_points', 'fantasy_points_g']
            ...
            headers = ['team', 'g', 'rec_target', 'rec_rec', 'rec_yds', 'rec_td', 'rush_att', 'rush_yds', 'rush_td',
                       'fantasy_points', 'fantasy_points_g']
